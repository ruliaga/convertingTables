...
def categories(df):
    ...
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Сверлильная"
    x = 'Cверлильная'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Сверлильная"
    x = 'Горизонтально-сверлильная'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Сверлильная"
    x = 'Токарная'
    y = 'ПУ'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]) and y not in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Токарная"
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]) and y in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Токарная с ПУ"
    x = 'Термообработка'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Термообработка"
    x = 'УЗК'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Контрольная УЗК"
    x = 'Фрезерн'
    for i in range(0,df.shape[0]):
        if x in str(df['Технологическая операция.Наименование'].values[i]):
            df['Технологическая операция.Наименование'].values[i] = "Фрезерная с ПУ"
